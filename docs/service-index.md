...
| Renewal recovery | [services/renewal-recovery-service](../services/renewal-recovery-service) | scaffold | Dunning, smart retries, and customer-facing recovery flows for renewal failures. |
...
| Customer portal | [services/customer-portal-service](../services/customer-portal-service) | scaffold | Generate and manage Stripe Billing Portal sessions and configurations. |
...
|---|---|---|
| Types | [shared/types](../shared/types) | Cross-service TS types and zod schemas. |
| Utils | [shared/utils](../shared/utils) | Generic helpers (time, money, retry, idempotency keys). |
| Storage | [shared/storage](../shared/storage) | Storage port + adapters used by services. |
| Logger | [shared/logger](../shared/logger) | Structured logger with trace correlation. |
| Test helpers | [shared/test-helpers](../shared/test-helpers) | Fixtures, fake clocks, Stripe event factories. |
...
| Hono | [examples/hono](../examples/hono) |
